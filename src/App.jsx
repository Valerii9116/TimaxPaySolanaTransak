...
const EvmIcon = () => (
 <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M12 2l-6 10.5L12 22l6-10.5L12 2z" /><path d="M6 12.5l6-10.5 6 10.5" /><path d="M6 12.5l6 9.5 6-9.5" /></svg>
);
const SolanaIcon = () => (
...
function App({ transakApiKey, transakEnvironment }) {
  ...
  useEffect(() => {
    ...
    // FIX: Removed selectedChain.assets from dependency array to prevent unnecessary re-runs.
