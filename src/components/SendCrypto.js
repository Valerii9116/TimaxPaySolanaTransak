...
// --- CONFIG ---
import { SUPPORTED_ASSETS, ASSET_ADDRESSES } from '../config';
  ...
  useEffect(() => {
    ...
    const scanner = new Html5QrcodeScanner(
      ...
      { 
        ...
        supportedScanTypes: [0] // 0 corresponds to SCAN_TYPE_CAMERA
      }, 
      false // verbose
    );
    ...
    const onScanSuccess = (decodedText) => {
      ...
      setScanning(false);
      scanner.clear().catch(err => console.error("Scanner clear failed after success", err));
    };
    ...
    <div className="terminal-body">
      ...
      <div className="selector-group">
        ...
        <div className="address-input-container">
          ...
          <button className="qr-scan-button" onClick={() => setScanning(!isScanning)} title="Scan QR Code">
      ...
      <button onClick={handleSend} className="launch-button" disabled={isInteractionDisabled || !toAddress || !amount}>Send {amount} {selectedAsset}</button>
    </div>
  );
}
